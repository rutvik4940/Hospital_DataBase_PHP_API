...
{
    $query="INSERT INTO user_booking_appointnent(`id`,`username`,`doctername`,`usercontact`,`age`,`weight`,`gender`,`address`,`disease`,`surgery`,`date`,`time`) VALUES ('$id','$username','$doctername','$usercontact','$age','$weight','$gender','$address','$disease','$surgery','$date','$time')";
